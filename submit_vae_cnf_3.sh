...
# Job name
#SBATCH -J mask_vae_cnf_w_grad_clip
...
# Output file
#SBATCH -o mask_vae_cnf_w_grad_clip-%j.out

# Error file
#SBATCH -e mask_vae_cnf_w_grad_clip-%j.err
...
python3 train_masked_vae_cnf.py --num_epochs 500 --use_kl_annealing --gradient_clipping --clip_value 1.0
