...
# Job name
#SBATCH -J mask_vae_cnf_w_cnf_norm
...
# Output file
#SBATCH -o mask_vae_cnf_w_cnf_norm-%j.out

# Error file
#SBATCH -e mask_vae_cnf_w_cnf_norm-%j.err
...
python3 train_masked_vae_cnf.py --num_epochs 500 --use_kl_annealing --cnf_norm
